package top.jasonkayzk.microservicefileupload.controller;
...
public class FileUploadController {
     ...
     */
//    @RequestMapping(value = "/upload", method = RequestMethod.POST, produces = {MediaType.APPLICATION_JSON_UTF8}, consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
